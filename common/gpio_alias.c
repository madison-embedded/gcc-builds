...
const GPIO GPIO_TABLE[] = {
	...
	/*Ch 1 PWM1*/
	FILL_AFIO("PT2",		GPIOA,  0, ALT, 1, LOW_SPEED, NONE, true, PROP)
	/*Ch 3 PWM2*/
	FILL_AFIO("PVS",		GPIOB,  10, ALT, 1, LOW_SPEED, NONE, true, PROP)
	/*Ch 4 PWM3*/
	FILL_AFIO("BPV",		GPIOB,  11, ALT, 1, LOW_SPEED, NONE, true, BRAKE) 
