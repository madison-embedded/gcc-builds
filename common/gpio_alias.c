...
const GPIO GPIO_TABLE[] = {
	...
	FILL_GPIO("Analog11",		GPIOF,  7, ANALOG, LOW_SPEED, NONE, true, OTHER)
	FILL_GPIO("Analog12",		GPIOF,  8, ANALOG, LOW_SPEED, NONE, true, OTHER)
	FILL_GPIO("Analog13",		GPIOF,  9, ANALOG, LOW_SPEED, NONE, true, OTHER)
	FILL_GPIO("Analog14",		GPIOA,  4, ANALOG, LOW_SPEED, NONE, true, OTHER)
	FILL_GPIO("Analog15",		GPIOA,  5, ANALOG, LOW_SPEED, NONE, true, OTHER)
